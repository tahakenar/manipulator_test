...
std::vector<double> forwardKinematicsFunc(const sensor_msgs::Joy::ConstPtr& joy);

std_msgs::Float64MultiArray returnActuatorVel(const std::vector<double> &actuatorVelocities);
